...
def text_to_textnodes(text):
    ...
    # code
    nodelist = split_nodes_delimiter([node], "`", TextType.Code_text)
    nodelist = split_nodes_delimiter(nodelist, "**", TextType.Bold_text)
    nodelist = split_nodes_delimiter(nodelist, "*", TextType.Italic_text)
